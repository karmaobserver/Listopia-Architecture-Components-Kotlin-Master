...
interface ProductDataSource {
    ...
    suspend fun getProductsNotSyncedSuspend(): State<List<ProductModel>>
    ...
    suspend fun saveOrUpdateProductsRemote(productModels: List<ProductModel>): State<Unit>
    ...
    suspend fun updateSyncProducts(productIds: List<String>): State<Int>
